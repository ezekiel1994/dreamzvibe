<div class="kode-comments">
                                    <div class="msl-black">
	                                    <div class="msl-heading light-color">
						                   <?php $main_comment = mysqli_num_rows(mysqli_query($con,"select * from video_comments where item_id = '$post_id' " )); ?>
						                    <h5><span>There are <?php echo $main_comment; ?> comment For this video</span></h5>
						                </div>
                                	</div>
                                    <ul id="kode-comment" class="comment">
									<?php
										$com = "select * from video_comments where item_id = '$post_id'";
									...
									?>
                                        <li class="grand_parent">
                                            ...
                                            <ul class="children">
											<?php
												$rep = "select * from video_replies where reply_header_id = '{$row['comment_id']}'";
