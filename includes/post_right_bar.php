<div class="widget widget-artist">
									...
									<?php 
								   $query1 = $con->query("select * from posts order by post_id desc limit 6");
                                    ...
                                    <div class="artists-rank-list">
                                        ...
                                        <div class="artists-rank">
                                            ...
                                            <div class="text-overflow">
                                                <h6><a href="blog-single.php?url=<?php echo $row['post_url']; ?>"><?php echo ucfirst($row['post_title']); ?></a></h6>
                                                <p><?php echo ucfirst($row['post_author']); ?></p>
                                            </div>
                                        </div>
